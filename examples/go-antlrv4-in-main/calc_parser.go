...
var parserATN = []uint16{
	...
	3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 7, 3, 31, 10, 3, 12, 3, 14, 3, 34,
	11, 3, 3, 3, 2, 3, 4, 4, 2, 4, 2, 4, 3, 2, 5, 6, 3, 2, 7, 8, 2, 37, 2,
	6, 3, 2, 2, 2, 4, 19, 3, 2, 2, 2, 6, 10, 5, 4, 3, 2, 7, 9, 7, 9, 2, 2,
	8, 7, 3, 2, 2, 2, 9, 12, 3, 2, 2, 2, 10, 8, 3, 2, 2, 2, 10, 11, 3, 2, 2,
	2, 11, 3, 3, 2, 2, 2, 12, 10, 3, 2, 2, 2, 13, 14, 8, 3, 1, 2, 14, 15, 7,
	3, 2, 2, 15, 16, 5, 4, 3, 2, 16, 17, 7, 4, 2, 2, 17, 20, 3, 2, 2, 2, 18,
	20, 7, 10, 2, 2, 19, 13, 3, 2, 2, 2, 19, 18, 3, 2, 2, 2, 20, 32, 3, 2,
	2, 2, 21, 22, 12, 5, 2, 2, 22, 23, 9, 2, 2, 2, 23, 31, 5, 4, 3, 6, 24,
	25, 12, 4, 2, 2, 25, 26, 8, 3, 1, 2, 26, 27, 9, 3, 2, 2, 27, 28, 5, 4,
	3, 5, 28, 29, 8, 3, 1, 2, 29, 31, 3, 2, 2, 2, 30, 21, 3, 2, 2, 2, 30, 24,
	3, 2, 2, 2, 31, 34, 3, 2, 2, 2, 32, 30, 3, 2, 2, 2, 32, 33, 3, 2, 2, 2,
	33, 5, 3, 2, 2, 2, 34, 32, 3, 2, 2, 2, 6, 10, 19, 30, 32,
}
			...
			case 2:
				...
				fmt.Printf("%v\n", (func() string {
					if localctx.(*ExprContext).GetLeft() == nil {
						...
						return p.GetTokenStream().GetTextFromTokens(localctx.(*ExprContext).GetLeft().GetStart(), localctx.(*ExprContext).left.GetStop())
					}
				}()))
				{
					p.SetState(24)
				...
				fmt.Printf("ctx: %v, start_line: %v, left: %v, right_start_token: %v\n", localctx.(*ExprContext), localctx.GetStart().GetLine(), (func() string {
					if localctx.(*ExprContext).GetLeft() == nil {
						return ""
					} else {
						return p.GetTokenStream().GetTextFromTokens(localctx.(*ExprContext).GetLeft().GetStart(), localctx.(*ExprContext).left.GetStop())
