...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"../../public/swagger-ui/dist", "GET", "/swagger-ui"},
		},
	}
}
...
func Mount(mux goahttp.Muxer) {
	...
	MountPublicSwaggerUIDist(mux, http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		upath := path.Clean(r.URL.Path)
		rpath := upath
		if strings.HasPrefix(upath, "/swagger-ui") {
			rpath = upath[11:]
		}
		http.ServeFile(w, r, path.Join("../../public/swagger-ui/dist", rpath))
	}))
}
...
// MountPublicSwaggerUIDist configures the mux to serve GET request made to
// "/swagger-ui".
func MountPublicSwaggerUIDist(mux goahttp.Muxer, h http.Handler) {
